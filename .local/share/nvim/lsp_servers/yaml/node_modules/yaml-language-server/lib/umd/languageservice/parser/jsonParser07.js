...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../utils/objects", "../utils/schemaUtils", "vscode-json-languageservice", "vscode-nls", "vscode-uri", "vscode-languageserver-types", "vscode-languageserver", "../utils/arrUtils", "../utils/strings"], factory);
    }
    ...
    class ValidationResult {
        ...
        mergeWarningGeneric(subValidationResult, problemTypesToMerge) {
            var _b, _c;
            if ((_b = this.problems) === null || _b === void 0 ? void 0 : _b.length) {
                for (const problemType of problemTypesToMerge) {
                    ...
                    for (const bestResult of bestResults) {
                        const mergingResult = (_c = subValidationResult.problems) === null || _c === void 0 ? void 0 : _c.find((p) => p.problemType === problemType &&
                ...
                for (const propertyName of Object.keys(schema.properties)) {
                    ...
                    if (child) {
                        if (objects_1.isBoolean(propertySchema)) {
                            ...
                            propertySchema.url = (_b = schema.url) !== null && _b !== void 0 ? _b : originalSchema.url;
    ...
    function getSchemaSource(schema, originalSchema) {
        ...
        if (schema) {
            ...
            if (schema.title) {
                ...
                const uriString = (_b = schema.url) !== null && _b !== void 0 ? _b : originalSchema.url;
                if (uriString) {
