...
import { DocumentFormattingRequest, DidChangeConfigurationNotification } from 'vscode-languageserver';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.yamlSettings.hasConfigurationCapability && this.yamlSettings.clientDynamicRegisterSupport) {
                try {
                    ...
                    yield this.connection.client.register(DidChangeConfigurationNotification.type, undefined);
                }
                catch (err) {
