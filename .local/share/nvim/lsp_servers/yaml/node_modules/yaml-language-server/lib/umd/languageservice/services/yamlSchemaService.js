...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../yamlLanguageService", "vscode-json-languageservice/lib/umd/services/jsonSchemaService", "vscode-uri", "vscode-nls", "../utils/strings", "yaml", "path", "./modelineUtil"], factory);
    }
    ...
    class YAMLSchemaService extends jsonSchemaService_1.JSONSchemaService {
        ...
        getSchemaForResource(resource, doc) {
            ...
            const resolveSchema = () => {
                ...
                const schemas = [];
                let schemaFromModeline = modelineUtil_1.getSchemaFromModeline(doc);
            ...
            return super.loadSchema(schemaUri).then((unresolvedJsonSchema) => {
                ...
                if (unresolvedJsonSchema.errors && unresolvedJsonSchema.schema === undefined) {
                    return requestService(schemaUri).then((content) => {
                        ...
                        try {
                            const schemaContent = yaml_1.parse(content);
