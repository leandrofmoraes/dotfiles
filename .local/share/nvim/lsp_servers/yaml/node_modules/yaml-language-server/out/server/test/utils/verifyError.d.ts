...
export declare function createUnusedAnchorDiagnostic(message: string, name: string, startLine: number, startCharacter: number, endLine: number, endCharacter: number): Diagnostic;
