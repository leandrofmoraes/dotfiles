...
describe('Validation Tests', () => {
    ...
    before(() => {
        ...
        const { languageService: langService, validationHandler: valHandler, yamlSettings: settings, telemetry: testTelemetry, } = testHelper_1.setupLanguageService(languageSettingsSetup.languageSettings);
...
`;
    ...
    describe('Bug fixes', () => {
        it('should handle bad schema refs', () => __awaiter(void 0, void 0, void 0, function* () {
            const schema = {
                type: 'object',
                properties: {
                    bar: {
        ...
        it('should not use same AST for completion and validation', () => __awaiter(void 0, void 0, void 0, function* () {
            const schema = {
                type: 'object',
                properties: {
                    container: {
  ...
  - ccc`;
            ...
            yamlSettings.documents = new yamlSettings_1.TextDocumentTestManager();
            yamlSettings.documents.set(testTextDocument);
            yield languageService.doComplete(testTextDocument, vscode_languageserver_1.Position.create(6, 8), false);
            const result = yield validationHandler.validateTextDocument(testTextDocument);
