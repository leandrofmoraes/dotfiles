...
local user_opts = {
    ...
    language = "pt",                        -- en:English - .json translations need implementing
    ...
    hide_timeout = 2000,                    -- time (in ms) before OSC hides if no mouse movement (1500 is default)
    ...
    date_format = "%d-%m-%Y",               -- how dates should be formatted, when read from metadata (uses standard lua date formatting) (default = "%Y-%m-%d")
    ...
    download_path = "~/Vídeos/mpv", -- default download directory for videos (https://mpv.io/manual/master/#paths)
    ...
    window_controls_close_hover = "#B542FF", -- color of close window control on hover
    window_controls_minmax_hover = "#62AEEF", -- color of min/max window controls on hover
    title_color = "#FFFFFF",                -- color of the title (above seekbar)
    seekbarfg_color = "#62AEEF",            -- color of the seekbar progress and handle, in Hex color format
    seekbarbg_color = "#FFFFFF",            -- color of the remaining seekbar, in Hex color format
    seekbar_cache_color = "#62AEEF",        -- color of the cache ranges on the seekbar
    ...
    thumbnail_border_color = "#B542FF",     -- color of the border for thumbnails (with thumbfast)
...
local language = {
  ...
  ['pt'] = {
    welcome = 'Arraste arquivos ou URLs aqui para reproduzir', -- este texto aparece quando o mpv inicia
    off = 'DESLIGADO',
    na = 'Não disponível',
    none = 'Nenhum disponível',
    video = 'Vídeo',
    audio = 'Áudio',
    subtitle = 'Legenda',
    nosub = 'Nenhuma legenda disponível',
    noaudio = 'Nenhuma faixa de áudio disponível',
    track = ' faixas:',
    playlist = 'Lista de reprodução',
    nolist = 'Lista de reprodução vazia',
    chapter = 'Capítulo',
    nochapter = 'Nenhum capítulo disponível',
    ontop = 'Fixar janela',
    ontopdisable = 'Desafixar janela',
    loopenable = 'Habilitar loop',
    loopdisable = 'Desabilitar loop',
    screenshot = "Captura de tela",
    statsinfo = "Informações",
    download = "Download",
    download_in_progress = "Download em progresso",
