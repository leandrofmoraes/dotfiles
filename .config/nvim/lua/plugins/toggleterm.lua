...
local options = {
  ...
  hide_numbers = true,
  -- dir = "%:p:h",
  shell = '/usr/bin/zsh', -- or vim.o.shell, -- change the default shell
...
-- local node = require('toggleterm'):new({
--   dir = '%:p:h',
--   cmd = 'node',
--   hidden = true,
--   direction = 'float',
...
return {
  ...
  -- keys = {
  --   { '<leader>rn', '<cmd>lua node:toggle()<cr>', desc = 'Node' },
  -- },
  --config = function()
