# Generated by Powerlevel10k configuration wizard on 2022-02-17 at 15:03 -03.
...
# disconnected, right frame, dark-ornaments, sparse, many icons, fluent,
...
() {
  ...
  # typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=$'#CCCCCC'
